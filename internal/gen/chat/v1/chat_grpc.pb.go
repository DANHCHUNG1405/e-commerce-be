...
const (
	ChatService_OpenConversation_FullMethodName  = "/ecommerce.chat.v1.ChatService/OpenConversation"
	ChatService_ListConversations_FullMethodName = "/ecommerce.chat.v1.ChatService/ListConversations"
	ChatService_ListMessages_FullMethodName      = "/ecommerce.chat.v1.ChatService/ListMessages"
	ChatService_SendMessage_FullMethodName       = "/ecommerce.chat.v1.ChatService/SendMessage"
	ChatService_MarkRead_FullMethodName          = "/ecommerce.chat.v1.ChatService/MarkRead"
)
...
type ChatServiceClient interface {
	...
	MarkRead(ctx context.Context, in *MarkReadRequest, opts ...grpc.CallOption) (*ReadMarker, error)
}
...
func (c *chatServiceClient) OpenConversation(ctx context.Context, in *OpenConversationRequest, opts ...grpc.CallOption) (*Conversation, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Conversation)
	err := c.cc.Invoke(ctx, ChatService_OpenConversation_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chatServiceClient) MarkRead(ctx context.Context, in *MarkReadRequest, opts ...grpc.CallOption) (*ReadMarker, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ReadMarker)
...
type ChatServiceServer interface {
	...
	MarkRead(context.Context, *MarkReadRequest) (*ReadMarker, error)
...
func (UnimplementedChatServiceServer) OpenConversation(context.Context, *OpenConversationRequest) (*Conversation, error) {
...
func (UnimplementedChatServiceServer) MarkRead(context.Context, *MarkReadRequest) (*ReadMarker, error) {
...
func _ChatService_OpenConversation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(OpenConversationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ChatServiceServer).OpenConversation(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ChatService_OpenConversation_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServiceServer).OpenConversation(ctx, req.(*OpenConversationRequest))
	}
...
var ChatService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ecommerce.chat.v1.ChatService",
	HandlerType: (*ChatServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "OpenConversation",
			Handler:    _ChatService_OpenConversation_Handler,
		},
		{
